                ...
                <nav class="flex flex-1 flex-col">
                  <ul role="list" class="flex flex-1 flex-col gap-y-7">
                    ...
                    <li class="mt-auto">
                      <a
                        href="#"
                        class="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold text-primary-200 hover:bg-primary-700 hover:text-white"
                      >
                        <Cog6ToothIcon
                          class="size-6 shrink-0 text-primary-200 group-hover:text-white"
                          aria-hidden="true"
                        />
                        Settings
                      </a>
