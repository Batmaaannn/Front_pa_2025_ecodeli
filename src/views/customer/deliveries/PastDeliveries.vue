  ...
  <div class="px-4 sm:px-6 lg:px-8">
    <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto">
        <h1 class="text-xl font-semibold text-gray-900">Livraisons passées</h1>
        <p class="mt-2 text-sm text-gray-700">
          Historique de toutes vos livraisons effectuées
        </p>
      </div>
    </div>
    ...
    <div class="mt-8 flow-root">
      ...
      <div
        v-else-if="announcementStore.pastDeliveries.length === 0"
          ...
          >
            <table class="min-w-full divide-y divide-gray-300">
              ...
              <tbody class="divide-y divide-gray-200 bg-white">
                <tr
                  v-for="delivery in announcementStore.pastDeliveries"
                  :key="delivery.id"
                >
                  <td
