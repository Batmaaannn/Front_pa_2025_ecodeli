...
onMounted(() => {
  authStore.initializeStepper([
    {
      name: "InformationsDeliveryAgent",
      pathName: "/inscription/livreur",
    },
    {
      name: "CompanyInformationsDeliveryAgent",
      pathName: "/inscription/livreur/entreprise",
    },
    {
      name: "VehiculeInformationsDeliveryAgent",
      pathName: "/inscription/livreur/vehicule",
    },
    {
      name: "CompanyDocumentsDeliveryAgent",
      pathName: "/inscription/livreur/documents",
    },
  ]);
